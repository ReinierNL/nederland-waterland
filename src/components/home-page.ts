    ...
    view: ({ attrs: { state, actions } }) => {
      ...
      return [
        m('.content', [
          ...
          selectedLayer && isCureLayer(selectedLayer!) &&  m('.disclaimer', 'Portefeuilleroutekaart status `cure` voor het laatst bijgewerkt: 16 september 2025'),
          selectedLayer && isCareLayer(selectedLayer!) &&  m('.disclaimer', 'Portefeuilleroutekaart status `care` voor het laatst bijgewerkt: 2 september 2025'),
        ]), // content
