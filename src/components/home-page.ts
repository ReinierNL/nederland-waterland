    ...
    view: ({ attrs: { state, actions } }) => {
      ...
      return [
        m('.content', [
          ...
          selectedLayer && isCureLayer(selectedLayer!) &&  m('.disclaimer', 'Portefeuilleroutekaart status `cure` voor het laatst bijgewerkt: 22 januari 2025'),
          selectedLayer && isCareLayer(selectedLayer!) &&  m('.disclaimer', 'Portefeuilleroutekaart status `care` voor het laatst bijgewerkt: 18 december 2024'),
        ]), // content
